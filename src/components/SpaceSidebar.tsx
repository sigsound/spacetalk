  ...
  return (
    <div className="w-[280px] bg-[#100f0f] border-r border-[#2a2827] flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          <div className="p-4 text-gray-500 text-sm">Loading spaces...</div>
        ) : spaces.length === 0 ? (
            ...
            {spaces.map((space) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Name and count */}
                  <div className="text-sm text-gray-200 truncate">{space.name}</div>
                  <div className="text-xs text-gray-500">{space.imageCount} images</div>
                </div>
              </label>
            ))}
          </div>
