    ...
    <div className="border-t border-gray-800 bg-[#0a0a0a] p-4">
      ...
      {uploadedFiles.length > 0 && (
        <div className="flex flex-wrap gap-2 mb-3">
          {uploadedFiles.map((file, index) => (
            <div
              key={index}
              className="flex items-center gap-2 bg-[#1a1a1a] border border-gray-700 rounded-full px-3 py-1 text-sm text-gray-300"
            >
      ...
      <div className="flex items-end gap-3">
        ...
        <textarea
          ...
          disabled={disabled}
          rows={1}
          className="flex-1 bg-[#1a1a1a] border border-gray-700 rounded-xl px-4 py-3 text-gray-100 placeholder-gray-500 resize-none focus:outline-none focus:border-gray-600 disabled:opacity-50"
